 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | Left | Left | Left |Space | /  Tab  /       \Enter \ |Bkspc | Del  |Right |Right |
 *            |Super | Alt  | Ctrl |(NAV) |/ (SYM) /         \      \|      |      |Alt   |Super |
 *            `----------------------------------'           '------''---------------------------'
 */
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,   KC_C,    KC_V,    KC_B, KC_MUTE,    KC_CLMK_DH, KC_N,   KC_M,   KC_COMM,    KC_DOT, KC_SLSH,  KC_RSFT,
             KC_LGUI, KC_LALT,  KC_LCTL, NAV_SPC, SYM_TAB,         KC_ENT,  KC_BSPC,  KC_DEL, KC_RALT, KC_RGUI
),
// -----------------------------------------------------------------------------------------------------------
 ...
 * |   \  |   Z  |   X  |   C  |   D  |   V  |-------|    |-------|   K  |   H  |   ,  |   .  |   /  |   -  |
 * `-----------------------------------------/      /     \      \-----------------------------------------'
 *            |      |CWord | NUM  |Space | / Tab  /       \Enter \ |Bkspc | Del  |      |      |
 *            |      |togg. |      |(NAV) |/(SYM) /         \      \|      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_COLEMAK_DH] = LAYOUT(
  ...
  KC_BSLS,  KC_Z,   KC_X,   KC_C,   KC_D,   KC_V,   KC_MUTE,      KC_QWERTY,    KC_K,   KC_H,   KC_COMM,KC_DOT, KC_SLSH,    KC_MINUS,
             KC_NO, CW_TOGG,  MO(_NUM), NAV_SPC, SYM_TAB,             KC_ENT,  KC_BSPC,  KC_DEL, KC_NO, KC_NO
),
// -----------------------------------------------------------------------------------------------------------
...
[_SYM] = LAYOUT(
  ...
  KC_NO,    KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,                      KC_EXCLAIM, KC_LEFT_PAREN,          KC_RIGHT_PAREN,         KC_ASTERISK,    KC_DOLLAR, KC_CIRCUMFLEX,
...
[_NUM] = LAYOUT(
  ...
  KC_NO,    KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  TRNS,       TRNS,   KC_0,    KC_1,    KC_2,    KC_3,    KC_NO,      KC_NO,
                    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,              KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
),
// -----------------------------------------------------------------------------------------------------------
/* ADJUST
